                ...
                <div className="container my-4 py-2">
                    <div className="row">
                        <div className="col-12">
                            ...
                            <h1 className="display-6 text-center mb-2">Our <b>Awesome</b> Services</h1>
                    ...
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <div class="card p-3">
                                ...
                                <div class="card-body text-center">
                                    <i className='fa fa-cogs fa-4x mb-4 text-primery'></i>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                {/* <img src="..." class="card-img-top" alt="..." /> */}
                                <div class="card-body text-center">
                                    <i className='fa fa-mobile fa-4x mb-4 text-primery'></i>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                {/* <img src="..." class="card-img-top" alt="..." /> */}
                                <div class="card-body text-center">
                                    <i className='fa fa-user fa-4x mb-4 text-primery'></i>
                                    <h5 class="card-title mb-3 fs-4 fw-bold">User Experiance</h5>
                                    <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    {/* <a href="#" class="btn btn-primary">Go somewhere</a> */}
                                </div>
                            </div>
                    ...
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <div class="card p-3">
                                {/* <img src="..." class="card-img-top" alt="..." /> */}
                                <div class="card-body text-center">
                                    <i className='fa fa-laptop fa-4x mb-4 text-primery'></i>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                {/* <img src="..." class="card-img-top" alt="..." /> */}
                                <div class="card-body text-center">
                                    <i className='fa fa-file-code-o fa-4x mb-4 text-primery'></i>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                {/* <img src="..." class="card-img-top" alt="..." /> */}
                                <div class="card-body text-center">
                                    <i className='fa fa-star-half-o fa-4x mb-4 text-primery'></i>
